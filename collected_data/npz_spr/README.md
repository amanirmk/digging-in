## Self-Paced Reading Item Design for NP/Z Digging-In Effects

The self-paced reading (SPR) experiment used 36 items of the following design.
...
- **Ambiguity**
  ...
  - unambiguous with comma resolution: the NP is disambiguated to the main clause by including a comma.
  - unambiguous with object resolution: the NP is disambiguated to the main clause by including a different NP under the subordinate clause.
- **Length**
