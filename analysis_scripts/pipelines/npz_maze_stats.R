...
source(here("analysis_scripts", "pipelines", "sub_pipelines", "maze_stats_human.R"))
source(here("analysis_scripts", "pipelines", "sub_pipelines", "maze_stats_pred.R"))
source(here("analysis_scripts", "pipelines", "sub_pipelines", "maze_stats_surp.R"))
source(here("analysis_scripts", "pipelines", "sub_pipelines", "maze_stats_human_vs_pred.R"))