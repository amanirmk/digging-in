...
for (finality in c("all", "final", "nonfinal")) {
  ...
  bar_plot_with_pattern(plot_data,
    ...
    width = 5,
    height = 3,
    figure_path = here("analysis_outputs", "npz_spr_figs", "critical_bars", paste0("empirical_crit_bar_", figure_suffix, img_filetype)),
...
for (critrel in c(1, 2)) {
  plot_data <- human_data %>%
    ...
    comprehension_filter(type="spr") %>%
    # average by item and condition, average resolution (combines unambiguous levels)
    by_item_condition_average(resolution = "average", y_var = "RT", x_var = "critical_relative", ignore_contrasts = NULL) %>%
  ...
  bar_plot_with_pattern(plot_data,
    ...
    width = 5,
    height = 3,
    figure_path = here("analysis_outputs", "npz_spr_figs", "critical_bars", paste0("empirical_crit_bar_", critrel, img_filetype)),
    legend_position = "right"
  )
}
...
bar_plot_with_pattern(plot_data,
  ...
  width = 5,
  height = 3,
  figure_path = here("analysis_outputs", "npz_spr_figs", "critical_bars", paste0("empirical_crit_bar_crit_thru_spill", img_filetype)),
  legend_position = "right"
)
...
for (finality in c("all", "final", "nonfinal")) {
  ...
  bar_plot_with_pattern(plot_data,
    ...
    width = 5,
    height = 3,
    figure_path = here("analysis_outputs", "npz_spr_figs", "critical_bars", paste0("surprisal_crit_bar_", figure_suffix, img_filetype)),
    legend_position = "right"
  )
}
...
for (finality in c("all", "final", "nonfinal")) {
  ...
  bar_plot_with_pattern(plot_data,
    ...
    width = 5,
    height = 3,
    figure_path = here("analysis_outputs", "npz_spr_figs", "critical_bars", paste0("pred_rt_crit_bar_", figure_suffix, img_filetype)),
    legend_position = "right"
  )
}
...
for (finality in c("all", "final", "nonfinal")) {
  ...
  bar_plot_with_pattern(plot_data,
    ...
    width = 5,
    height = 3,
    figure_path = here("analysis_outputs", "npz_spr_figs", "critical_bars", paste0("residual_crit_bar_", figure_suffix, img_filetype)),
    legend_position = "right"
  )
}
...
bar_plot_with_pattern(plot_data,
  ...
  width = 5,
  height = 3,
  figure_path = here("analysis_outputs", "npz_spr_figs", "critical_bars", paste0("empirical_crit_bar_nonfinal_critonward", img_filetype)),
  legend_position = "right"
)

# combined empirical and predicted
...
for (finality in c("all", "final", "nonfinal")) {
  ...
  bar_plot_with_pattern(plot_data %>% filter(length == "short"),
    ...
    width = 5,
    height = 3,
    figure_path = here("analysis_outputs", "npz_spr_figs", "critical_bars", paste0("combined_crit_bar_short_", figure_suffix, img_filetype)),
    legend_position = "right"
  )
  ...
  bar_plot_with_pattern(plot_data %>% filter(length == "long"),
    ...
    width = 5,
    height = 3,
    figure_path = here("analysis_outputs", "npz_spr_figs", "critical_bars", paste0("combined_crit_bar_long_", figure_suffix, img_filetype)),
    legend_position = "right"
  )
}
...
for (resolution in c("comma", "object")) {
  if (resolution == "comma") {
    human_subset <- human_data %>% filter(ambiguity == "ambiguous" | resolution == "comma")
    pred_subset <- pred_data %>% filter(ambiguity == "ambiguous" | resolution == "comma")
    figure_suffix <- "comma"
  } else {
    human_subset <- human_data %>% filter(ambiguity == "ambiguous" | resolution == "object")
    pred_subset <- pred_data %>% filter(ambiguity == "ambiguous" | resolution == "object")
  ...
  human_plot_data <- human_subset %>%
    ...
    by_item_condition_average(resolution = "separate", y_var = "RT", x_var = "critical_relative", ignore_contrasts = c("finality")) %>%
    filter(critical_relative == 0) %>%
    # get error bars for condition means over items
    over_item_average(y_var = "RT", x_var = "critical_relative") %>%
    code_npz_data()
